...
if __name__ == '__main__':
    ...
    for path in cgp.get_paths_between_activities('org.secuso.privacyfriendlytodolist.view.MainActivity',
                                                 'org.secuso.privacyfriendlytodolist.view.AboutActivity'):
        print(path)
